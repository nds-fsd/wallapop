    ...
    return (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={styles.sectionForm}>
            <div className={styles.inmueblesTitle}>
                <div className={styles.inmuebles}>
                    ...
                    <div className={styles.inmuebles}>
                        ...
                        <input id='inmuebles' {...register('category')} type='checkbox' value ='inmobiliaria' checked  ></input>
                    </div>
                </div>
                ...
                <Controller name='space' control={control} defaultValue={false} render={({field}) => (
                    <div className={styles.type}>
                        <label htmlFor='piso' className={styles.square}>
                            <input id='piso' type='radio' {...register('characteristics.space')} {...field} value='piso' name='space'></input>
                            <span className='icon-star-empty'></span>
                            Piso
                        </label>
                        <label htmlFor='casa' className={styles.square}>
                            <input id='casa' type='radio' {...register('characteristics.space')} {...field} value='casa' name='space'></input>
                            <span className='icon-star-empty'></span>
                            Casa
                        </label> 
                        <label htmlFor='habitacion' className={styles.square}>
                            <input id='habitacion' {...register('characteristics.space')} type='radio' {...field} value='habitacion' name='space'></input>
                            <span className='icon-star-empty'></span>
                            Habitación
                        </label> 
                        <label htmlFor='oficina' className={styles.square}>
                            <input id='oficina'  {...register('characteristics.space')} type='radio' {...field} value='oficina' name='space'></input>
                            <span className='icon-star-empty'></span>
                            Oficina
                        </label>
                        <label htmlFor='garaje' className={styles.square}>
                            <input id='garaje' {...register('characteristics.space')} type='radio' {...field} value='garaje' name='space'></input>
                            <span className='icon-star-empty'></span>
                            Garaje
                        </label>
                        <label htmlFor='trastero' className={styles.square}>
                            <input id='trastero'  {...register('characteristics.space')} type='radio' {...field} value='trastero' name='space'></input>
                            <span className='icon-star-empty'></span>
                            Trastero
                        </label>    
                    </div>    
            ...
            <div className={styles.column}>       
                <input type='number' min='1' {...register('characteristics.land')} placeholder='En m2' className={styles.inputLand}></input>
            ...
            <FormImages />
            <Map />
            <input type='submit'  className={styles.formButton} value='subir'></input>
