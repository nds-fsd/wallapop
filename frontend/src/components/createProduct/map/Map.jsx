  ...
  return (
    <>
      <div>
        ...
        <input placeholder="Señala dónde se ubica tu producto" className={styles.input}></input>
        <iframe 
      ...
      <label htmlFor="map">
        <p>Ésta es la ubicación de tu perfil de ReTrend. En ella aparecerán tus productos.</p>
      </label>
    </>
