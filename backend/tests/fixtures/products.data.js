const products = [
  ...
  {
    _id: "646b7ead6a04146e10047a3a",
    booked: false,
    datePublication: "2023-06-02T11:04:49.667+00:00",
    title: "BMW S1, perfecto estado",
    description:
      "Oportunidad perfecta para hacerte con un BMW S1 en perfecto estado y casi sin usar. Lo cambio por querer comprarme un utilitario que consuma menos. Este coche no te defraudará.",
    price: 9520,
    status: "Poco uso",
    sold: false,
    keywords: ["BMW", "veloz"],
    categories: ["644fe58f93ff3b3b028e575c"],
    category: "Coches",
    brand: "BMW",
    model: "S1",
    year: 2015,
